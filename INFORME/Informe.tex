...
\begin{table}[H]
  ...
  \label{tab:addlabel}%
\end{table}%       
~\\La ANOVA dio como resultado que las interacciones $AC$ y $AD$ son significativas, sin embargo la interacción $ACD$ no lo es, lo que nos dice que tanto al temperatura combinada con la concentración como la temperatura combinada con la velocidad de agitación tiene un efecto sobre el indice de filtración.
\subsection{Ejemplo diseño fraccionado un medio con una sola réplica}
~\\Se retoma el ejemplo anterior y se propone una fracción un medio del diseño $2^4$. Se usará el diseño $2^{4-1}$ con $I=ABCD$. Para construir el diseño, primero se apunta el diseño básico, el cual es un diseño $2^3$. Para encontrar los niveles del cuarto factor, se resuelve $I=ABCD$ para $D$, o $D=ABC$. Por lo tanto, el nivel de D de cada corrida es el producto de los signos positivos y negativos de las columnas A,B y C. El procso se ilustra en la siguiente tabla
% Table generated by Excel2LaTeX from sheet 'Hoja1'
\begin{table}[htbp]
  \centering
  \caption{Add caption}
